...
public class GpsTracker extends Service implements LocationListener {
    ...
    public GpsTracker(Context context) {
        ...
        try { locationManager = (LocationManager) mContext.getSystemService(LOCATION_SERVICE);
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (locationManager != null) {
                    ...
                    if (locationManager != null) { location = locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER); if (location != null) {
        ...
        if(location != null) { longitude = location.getLongitude(); } return longitude; }
        @Override
